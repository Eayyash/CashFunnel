...
- **Merge logic:** additive (see safety rule above) — every file's reports get summed into the running totals, joined against the newest `Acquisition_for_Loans_*.csv` present in the project root by CivilID
